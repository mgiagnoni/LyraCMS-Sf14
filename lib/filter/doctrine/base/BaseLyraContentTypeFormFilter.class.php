...
abstract class BaseLyraContentTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'item_slug'                  => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'item_slug'                  => new sfValidatorPass(array('required' => false)),
  ...
  public function addContentTypeCatalogsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.LyraContentTypeCatalog LyraContentTypeCatalog')
